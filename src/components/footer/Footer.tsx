      ...
      <nav>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              <Link to="https://developer.themoviedb.org/docs" target="_blank">
                API
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              <Link to="/documentation/website/terms-of-use">Terms of Use</Link>
            </li>
            <li>
              <Link to="/documentation/api/terms-of-use">API Terms of Use</Link>
            </li>
            <li>
