...
const MovieDetailPage = () => {
  ...
  //   path: `/${movieId ? "movie" : "tv"}/${movieId ? movieId : tvId}`,
  //   params: {},
  // });
  // const [movieCredits, isMovieCreditsLoading, moviewCreditError] = useFetch({
  //   path: `/${movieId ? "movie" : "tv"}/${movieId ? movieId : tvId}/credits`,
  //   params: {},
  // });

  // const [movieReview, isMoviewReviewLoading, moviewReviewError] = useFetch({
  //   path: `/${movieId ? "movie" : "tv"}/${movieId ? movieId : tvId}/reviews`,
  //   params: {},
  // });
  return (
    <div>
      {isMovieLoading && <div className="movie-banner-skeleton"></div>}
      {movieData && (
        <div
                ...
                <div className="movie-user-actions">
                  <div className="progress-bar-action">
                    <div className="progress-chart">
                      <CircularProgress vote_average={movieData.vote_average} />
                    </div>
                    <div>
                      User <br /> Score
                    </div>
                  ...
                  <div className="user-personalise">
                    ...
                    <div className="tooltip">
                      ...
                      <div className="tooltip-text">Add to your watchlist</div>
                    </div>
